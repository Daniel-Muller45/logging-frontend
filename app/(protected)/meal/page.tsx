...
export default function Page() {
    ...
    const [user, setUser] = useState<UserState>({id: null, username: null, age: null, height: null, weight: null}); // Simplified user state
    ...
    const totalFat = meals.reduce((total, meals) => total + meals.fat, 0);
        ...
        {isLogging ? (
          ...
          <div>
            ...
            <div className="text-center my-4">
              <h2 className="my-2">
                Calories (kcal): {totalCalories.toPrecision(4)}/2800
              </h2>
              <h2 className="my-2">
                Protein (g): {totalProtein.toPrecision(4)}/120
              </h2>
              <h2 className="my-2">
                Fat (g): {totalFat.toPrecision(4)}/90
              </h2>
              <h2 className="my-2">
                Carbohydrates (g): {totalCarbs.toPrecision(4)}/90
              </h2>
            </div>
            <div>
              {meals.length > 0 ? (
                  ...
                  <Card className="my-4">
                    <CardHeader>
                      ...
                      <CardDescription>
                        <div className="mt-2">
                          Calories (kcal):{' '}
                          {isEditMode ? <Input value={meal.cal} /> : meal.cal}
                        </div>
                        <div className="mt-2">
                          Protein (g):{' '}
                          {isEditMode ? (
                        ...
                        <div className="mt-2">
                          Fat (g):{' '}
                          {isEditMode ? <Input value={meal.fat} /> : meal.fat}
                        </div>
                        <div className="mt-2">
                          Carbohydrates (g):{' '}
                          {isEditMode ? (
        ...
        <div className="fixed bottom-0 left-0 z-50 w-full h-16 bg-inherit ">
          <div className="grid h-full max-w-lg grid-cols-2 mx-auto font-medium">
            <Button
              ...
              className="bg-inherit inline-flex flex-col items-center justify-center px-5 dark:hover:bg-gray-800 group"
            >
              <svg
